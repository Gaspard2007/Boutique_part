  ...
  return (
    <>
      <div className='flex flex-row' style={{margin:'20px'}}>
        <div className='w-3/4' style={{marginRight:'10px'}}>
        ...
        <div className='w-1/4' >
          ...
          <div className='flex flex-row justify-end' style={{margin:'10px'}}>
            ...
            <Link className='bg-black text-white text-xl rounded no-underline' style={{padding:'9px'}} href='/boutique'>Annuler</Link>
            </div>
            <div className=''>
            <Link className='bg-black text-white text-xl rounded no-underline' style={{padding:'9px'}} href='/d'>Continuer</Link>
            </div>
          </div>
        </div>
      </div>
